...
function Info({name,setname,subtitle,setsubtitle,userdesc,setuserdesc,email,setemail,contact,setcontact,address,setaddress,github,setgithub,linkedin,setlinkedin,portfolio,setportfolio}) {
    return (
        <div>
            <div className="form">
                       ...
                       {/*      <div className="input-box">
                            ...
                            <div className="input-box">
                                <span className="details">Work Role</span>
                                <input type="text" placeholder="Enter Position" value={subtitle} onChange={e=>setsubtitle
                                    (e.target.value)}/>
                            </div>
                            <div className="input-box textarea">
                                <span className="details">Summary</span>
                                <textarea type="text" placeholder="Start typing..." value={userdesc} onChange={e=>setuserdesc(e.target.value)}/>
                            </div>
                        </div>
                        <h1 className="heading" >About & Contact</h1>
